...
export const RegisterDrink: React.FC<InputedDrinkInfo> = ({
    ...
    isSelectTypeError,
    isDisableSubmit,
    handleChangeDrinkName,
    handleChangeDrinkTypeSelectBox,
    handleChangeMlPerOneDrinkSelectBox,
    handleRequestRegisterButton,
}) => {
    ...
    return (
        <Container>
            ...
            <FormControl fullWidth sx={{ m: 1 }}>
                <InputLabel error={isNameError}>ドリンク名</InputLabel>
                <OutlinedInput
                    label="ドリンク名"
